...
// for con continue
document.write("FOR CON CONTINUE se salta el elemento de queramos "+"<br>"+"<br>");
...
document.write("<br>"+"FOR IN devuelve el indice de los elementos "+"<br>"+"<br>");
// FOR IN
...
document.write("<br>"+"FOR OF devuelve el valor de los elementos "+ "<br>"+"<br>");
